...
from tdma_sim_v1.config.execution import ExecutionConfig
from tdma_sim_v1.config.logging import LoggingConfig
from tdma_sim_v1.lab import suboptimal
from tdma_sim_v1.lab.comparison import Comparison
from tdma_sim_v1.lab.custom import Custom
from tdma_sim_v1.lab.experiment import Experiment
from tdma_sim_v1.lab.optimal import Optimal
from tdma_sim_v1.lab.suboptimal import Suboptimal
from tdma_sim_v1.lab.summary import Summary
...
if __name__ == '__main__':
    ...
    if 'experiment' in commands:
        print('Loading module: experiment...')
        experiment = Experiment(ExecutionConfig.config)
